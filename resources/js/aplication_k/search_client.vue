    ...
    <div class="container-md">
        <el-card class="box-card mt-3">
            ...
            <el-table :data="handle_provider" style="width: 100%"  :ref="'tables_data'">
                ...
                <el-table-column label="Limite de Credito" prop="credit_limit"></el-table-column>
        ...
        <el-dialog
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :xs="25" :sm="6" :md="8" :lg="6" :xl="4">
                        <el-form-item label="Limite Credito:">
                    ...
                    //   last_name: this.form.last_name,
                      ...
                      if (status == "200") {
                        ...
                        //   this.form.last_name = '';
                          ...
                          this.$message({
                              message: h("p", null, [
                                  h("i", { style: "color: teal" }, "Cliente Modificado")
                              ]),
                              type: 'success'
                          });
                ...
                axios.post(url,{id: this.id_delete},config).then(response => {
                    const status = JSON.parse(response.status);
                      if (status == "200") {
                          this.$message({
                              message: h("p", null, [
                                  h("i", { style: "color: teal" }, "Cliente Eliminado!")
                              ]),
                              type: 'error'
                          });
                          this.handle_data_provider();
