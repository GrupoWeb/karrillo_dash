    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="typography.html">
                <i class="nav-icon fas fa-handshake-o"></i> Clientes</a>
        </li>
        <li class="nav-title">Aplicación</li>
        <li class="nav-item nav-dropdown">
            <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i> Facturación</a>
        ...
        <li class="nav-item px-3 d-compact-none d-minimized-none">
            ...
            <small class="text-muted">Q 10,000</small>
        </li>
        <li class="nav-item px-3 d-compact-none d-minimized-none">
            <div class="text-uppercase mb-1">
                <small>
            ...
            <small class="text-muted">Q 2,000 ENERO 2020</small>
        </li>
        <li class="nav-item px-3 mb-3 d-compact-none d-minimized-none">
            ...
            <small class="text-muted">Q 1,500 FEBRERO 2020</small>
        </li>
    </ul>
</nav>
